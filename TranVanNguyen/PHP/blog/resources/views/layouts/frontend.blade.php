            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="category.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tags</a>
                  <div class="dropdown-menu" aria-labelledby="dropdown04">
                      @foreach ($lsTag as $tag)
                        <a class="dropdown-item" href="view_post_tag/{{$tag -> id}}">{{$tag -> name}}</a>
                      @endforeach
                  </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown05">
                    @foreach ($lsCate as $cate)
                      <a class="dropdown-item" href="view_post_cate/{{$cate -> id}}">{{$cate -> name}}</a>
                    @endforeach
