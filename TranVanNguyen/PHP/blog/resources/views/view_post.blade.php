        ...
        <div class="container">
          ...
          <div class="row blog-entries element-animate">
            ...
            <div class="col-md-12 col-lg-8 main-content">
              ...
              <h3 class="mb-5">{{$post -> comments -> where('status',1) -> count()}} Comments</h3>
                ...
                <form action="{{asset('/post_comment/'.$post -> id)}}"  method="POST" class="p-5 bg-light">
                  @csrf
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" cols="30" rows="10" id="website" name="content"></textarea>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="submit" value="Post Comment"  class="btn btn-primary" id="submit_comment">
                    </div>
